{
	...
	"model":
	{
		...
		"responsiveHeight": 		{ "type": "int", "default": 300, "tags": {"doc": "GMaps height to be set in a responsive form. When responsiveHeight is set to 0, the component will use 100% height of the parent container"} }
	},
	"types": {
		"marker" : {
